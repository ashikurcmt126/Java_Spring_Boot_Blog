...
import com.ashikur.spring.blogapi.repository.UserSubscriptionsRepository;
import com.ashikur.spring.blogapi.entities.User;
import com.ashikur.spring.blogapi.entities.UserSubscription;
import com.ashikur.spring.blogapi.entities.extensions.UserExtension;
import com.ashikur.spring.blogapi.errors.exceptions.UnexpectedStateException;
...
public class UserSubscriptionsService {
    ...
    private List<UserExtension> getRelationsFromUser(Long id) {
        String hql = "select new com.ashikur.spring.blogapi.entities.extensions.UserExtension(" + id + ", ur.follower.username, ur.following.username, ur.follower.id, ur.following.id) from UserRelations ur where ur.follower.id=:userId or ur.following.id=:userId";
