...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    @Query("SELECT new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id, a.title,a.slug, a.description,a.user.id,a.user.username, a.publishOn, a.comments.size) FROM Article a inner join a.categories c WHERE c.slug = :slug")
    ...
    @Query("SELECT new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id, a.title,a.slug, a.description,a.user.id,a.user.username, a.publishOn, a.comments.size) FROM Article a inner join a.tags t WHERE t.slug = :slug")
    ...
    @Query("select new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id) from Article a where a.user.id <> :userId")
    ...
    @Query("select new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id, a.title, a.slug, a.description, a.body," +
            // " a.comments," +
            // " count(a.likes)," +
    ...
    @Query("select a from Article a where a.user.id in (select user.id from User user inner join com.ashikur.spring.blogapi.entities.UserSubscription relation on user.id=relation.following.id where relation.follower.id=:userId)")
    ...
    @Query("select new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id) from Article a where a.id =:articleId")
    Article getProxyForSave(@Param("articleId") Long articleId);

    @Query("select new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id, a.title, a.slug, a.description,a.user.id, a.user.username, a.publishOn) from Article a")
    ...
    @Query("select new com.ashikur.spring.blogapi.entities.extensions.ArticleExtension(a.id) from Article a where a.slug =:slug")
